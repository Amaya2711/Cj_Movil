...
import { getHormigas } from '../api/Hormigas';
import { getSolicitantes } from '../api/solicitantes';
import { getDatosOc } from '../api/datosOc';
import { aprobarPlanilla } from '../api/Hormigas';
import { TextInput, List } from 'react-native-paper';

export default function ReAprobarHormigasScreen({ navigation }) {
  ...
  console.log('ReAprobarHormigasScreen montado');
  ...
  const buscar = async () => {
    ...
    try {
      const reaprobaciones = await getHormigas({ IdSolicitante: idSolicitante });
